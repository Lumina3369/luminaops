        ...
        <div className="rounded-3xl border border-black/10 bg-white p-8 shadow-sm dark:border-white/10 dark:bg-zinc-950 sm:p-12">
          <div className="flex flex-col gap-6">
            ...
            <p className="text-lg leading-8 text-zinc-700 dark:text-zinc-300">
              I’m building <span className="font-semibold">GindeeOps</span>: a small, practical kit of
              checklists, templates, and “guardrails” that helps you run an AI assistant safely
            ...
            <div className="mt-2 flex flex-col gap-3 sm:flex-row">
              <a
                ...
                href="mailto:gindee3369@gmail.com?subject=GindeeOps%20Waitlist&body=Add%20me%20to%20the%20waitlist%20for%20GindeeOps.%0A%0AUse%20case:%20"
              >
                Join the waitlist
              </a>
              <a
